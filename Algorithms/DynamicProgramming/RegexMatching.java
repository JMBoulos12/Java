...
/*
 * Given a text and wildcard pattern implement a wildcard pattern matching algorithm that finds if wildcard is matched with text. 
 * The matching should cover the entire text ?-> matches single characters *-> match the sequence of characters
 *
