 ...
 * here, n is the no. whose square root has to be calculated and x has to be guessed such that, the calculation should result into the square root of n.
 * And the root will be obtained when the error < 0.5 or the precision value can also be changed according to the user preference. 
