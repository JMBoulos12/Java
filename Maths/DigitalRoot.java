...
class DigitalRoot {
    ...
    // n / 10 is the number obtainded after removing the digit one by one Sum of digits is stored in the Stack memory and then finally returned
