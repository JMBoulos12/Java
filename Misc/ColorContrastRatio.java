...
/*
 * @brief A Java implementation of the offcial W3 documented procedure to calculate contrast ratio between colors on the web. 
 * This is used to calculate the readability of a foreground color on top of a background color. 
  
  21-February-2023
*/


package com.jmboulos.misc;
