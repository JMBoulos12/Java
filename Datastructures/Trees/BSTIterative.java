 ...
 *
 * <p>
 * An implementation of BST iteratively. 
 * Binary Search Tree is a binary tree which satisfies three properties: left child is less than root node, 
 * right child is grater than root node, both left and right childs must themselves be a BST.
 *.java 
