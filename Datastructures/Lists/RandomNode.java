...
package com.jmboulos.datastructures.lists;
...
public class RandomNode {
    ...
    public RandomNode(ListNode head) {
        ...
        // Now using while loop to traverse through the linked list and go on adding values and increasing the size value by 1
        while (temp != null) {
            list.add(temp.val);
            temp = temp.next;
            size++;
